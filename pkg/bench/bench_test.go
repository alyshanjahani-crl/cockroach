...
// BenchmarkASH measures the overhead of ASH (Active Session History) sampling
// on SQL workloads. It runs scan and insert workloads with ASH disabled and
// enabled at various sample intervals, reporting the delta and allocations.
